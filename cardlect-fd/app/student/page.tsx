              ...
              <div className="mt-5 relative z-10 h-10">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={chartDataPoints} aria-hidden>
                    ...
                    />
                    <Line type="monotone" dataKey="y" stroke={metric.color} strokeWidth={2} dot={false} isAnimationActive activeDot={{ r: 3, stroke: metric.color, strokeWidth: 1 }} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={chartData}>
                ...
                />
                <Area type="monotone" dataKey="grade" stroke={CARDLECT_COLORS.primary.darker} strokeWidth={2} fill="url(#grad-performance)" isAnimationActive />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
