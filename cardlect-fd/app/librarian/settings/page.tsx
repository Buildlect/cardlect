...
export default function LibrarianSettingsPage() {
  const [settings, setSettings] = useState({
    fullName: 'Emma Davis',
    email: 'emma.davis@cardlect.edu',
    phone: '+234-902-345-6789',
    department: 'Library Services',
    notifications: {
      bookNotifications: true,
  ...
  return (
    <DashboardLayout currentPage="settings" role="librarian">
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Settings</h1>
          <p className="text-muted-foreground">Manage your librarian account and preferences</p>
        </div>
