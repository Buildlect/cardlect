...
export const defaultMenuItems = {
  admin: [
    ...
    { icon: MessageSquare, label: "Communication", href: "/dashboard/admin/communication", id: "communication" },
  ] as MenuItem[],
  security: [
    ...
    { icon: MessageSquare, label: "Communication", href: "/dashboard/security/communication", id: "communication" },
    { icon: Settings, label: "Settings", href: "/dashboard/security/setting", id: "setting" },
  ] as MenuItem[],
  "super-user": [
    ...
    { icon: FileText, label: "Logs", href: "/dashboard/super-user/logs", id: "logs" },
    { icon: Upload, label: "Bulk Import", href: "/dashboard/super-user/bulk-import", id: "bulk-import" },
    { icon: MessageSquare, label: "Communication", href: "/dashboard/super-user/communication", id: "communication" },
    { icon: Key, label: "Manage API Keys", href: "/dashboard/super-user/api", id: "api" },
    { icon: Settings, label: "Settings", href: "/dashboard/super-user/settings", id: "settings" },
  ] as MenuItem[],
  parents: [
    ...
    { icon: MessageSquare, label: "Communication", href: "/dashboard/parent/communication", id: "communication" },
    ...
    { icon: Settings, label: "Settings", href: "/dashboard/parent/settings", id: "settings" },
  ] as MenuItem[],
  students: [
    ...
    { icon: MessageSquare, label: "Communication", href: "/dashboard/student/communication", id: "communication" },
    ...
    { icon: Settings, label: "Settings", href: "/dashboard/student/settings", id: "settings" },
  ] as MenuItem[],
  finance: [
    ...
    { icon: MessageSquare, label: "Communication", href: "/dashboard/finance/communication", id: "communication" },
    ...
    { icon: Settings, label: "Settings", href: "/dashboard/finance/settings", id: "settings" },
  ] as MenuItem[],
  store: [
    ...
    { icon: MessageSquare, label: "Communication", href: "/dashboard/store/communication", id: "communication" },
    ...
    { icon: Settings, label: "Settings", href: "/dashboard/store/settings", id: "settings" },
  ] as MenuItem[],
  teacher: [
    ...
    { icon: MessageSquare, label: "Communication", href: "/dashboard/teacher/communication", id: "communication" },
    ...
    { icon: Settings, label: "Settings", href: "/dashboard/teacher/settings", id: "settings" },
  ] as MenuItem[],
  clinic: [
    ...
    { icon: MessageSquare, label: "Communication", href: "/dashboard/clinic/communication", id: "communication" },
    ...
    { icon: Settings, label: "Settings", href: "/dashboard/clinic/settings", id: "settings" },
  ] as MenuItem[],
  "approved-stores": [
    ...
    { icon: MessageSquare, label: "Communication", href: "/dashboard/approved-stores/communication", id: "communication" },
    ...
    { icon: Settings, label: "Settings", href: "/dashboard/approved-stores/settings", id: "settings" },
  ] as MenuItem[],
  "exam-officer": [
    ...
    { icon: MessageSquare, label: "Communication", href: "/dashboard/exam-officer/communication", id: "communication" },
    { icon: BarChart3, label: "Reports", href: "/dashboard/exam-officer/reports", id: "reports" },
    { icon: Settings, label: "Settings", href: "/dashboard/exam-officer/settings", id: "settings" },
  ] as MenuItem[],
  "librarian": [
    ...
    { icon: MessageSquare, label: "Communication", href: "/dashboard/librarian/communication", id: "communication" },
    ...
    { icon: Settings, label: "Settings", href: "/dashboard/librarian/settings", id: "settings" },
  ] as MenuItem[],
  "visitor": [
