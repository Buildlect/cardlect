...
const menuItems: { icon: IconComp; label: string; href: string; id: string }[] = [
  { icon: Icons.Squares2X2Icon, label: 'Dashboard', href: '/super-user', id: 'dashboard' },
  { icon: Icons.BuildingLibraryIcon, label: 'Manage Schools', href: '/super-user/schools', id: 'schools' },
