...
export default function SettingsPage() {
  ...
  const [email, setEmail] = useState('security@cardlect.io')
  const [fullName, setFullName] = useState('Security Officer')
  const [timezone, setTimezone] = useState('UTC')
  const [dateFormat, setDateFormat] = useState('DD/MM/YYYY')

  return (
    <div className="flex h-screen bg-background">
      <SecuritySidebar open={sidebarOpen} onToggle={() => setSidebarOpen(!sidebarOpen)} onNavigate={(href) => router.push(href)} currentPage="settings" />
